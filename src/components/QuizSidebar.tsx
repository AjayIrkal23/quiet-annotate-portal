...
interface QuizSidebarProps {
  ...
  feedbackBoxes: { [id: string]: "green" | "red" | undefined };
}
...
const QuizSidebar: React.FC<QuizSidebarProps> = ({
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 border border-gray-700/50 min-w-[260px] w-full max-w-xs">
