        ...
        <div className="p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <button onClick={() => setBoundingBoxes([])} className="flex items-center space-x-2 bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-lg transition-all duration-200">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 shadow-2xl h-full">
            <div className="p-6 h-full flex flex-col">
              ...
              <div ref={containerRef} className="relative flex-1 bg-gray-900 rounded-xl overflow-hidden border border-gray-600">
                <canvas ref={canvasRef} width={800} height={600} className="absolute inset-0 cursor-crosshair" onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} style={{
                ...
                return <div key={box.id} className="absolute border-2 bg-opacity-10 rounded pointer-events-none" style={{
                ...
                {currentBox && currentBox.width !== 0 && currentBox.height !== 0 && <div className="absolute border-2 border-dashed bg-opacity-20 rounded pointer-events-none" style={{
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 shadow-2xl">
              ...
              <Select value={selectedIssue} onValueChange={setSelectedIssue}>
                ...
                <SelectContent className="bg-gray-800 border-gray-600">
                  {allIssues.map(issue => <SelectItem key={issue.value} value={issue.value} className="text-white hover:bg-gray-700">
              ...
              <button onClick={addCustomIssue} className="w-full mt-3 flex items-center justify-center space-x-2 bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-lg transition-all duration-200">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 shadow-2xl">
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {boundingBoxes.length === 0 ? <div className="text-center py-8">
                  ...
                  </div> : boundingBoxes.map((box, index) => {
                const issueData = allIssues.find(i => i.value === box.issue);
                return <div key={box.id} className="bg-gray-700/50 rounded-lg p-3 border border-gray-600/50">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                        ...
                        backgroundColor: issueData?.color || '#6b7280'
                          ...
                          <button onClick={() => deleteBoundingBox(box.id)} className="text-red-400 hover:text-red-300 transition-colors">
